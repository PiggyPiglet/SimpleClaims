...
public class ClaimPlaceBucketInteraction extends PlaceFluidInteraction {

    public static final BuilderCodec<ClaimPlaceBucketInteraction> CUSTOM_CODEC = BuilderCodec.builder(ClaimPlaceBucketInteraction.class, ClaimPlaceBucketInteraction::new, PlaceFluidInteraction.CODEC).build();
